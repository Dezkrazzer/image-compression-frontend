...
export default function Header() {
  ...
  return (
    <motion.header
      ...
      className="fixed top-4 left-1/2 -translate-x-1/2 z-50 glass-card rounded-full px-4 sm:px-6 h-14 flex items-center justify-between gap-3 sm:gap-6"
    ...
    >
      ...
      <div className="flex min-w-23 items-center justify-end gap-2 text-dark-300 text-xs sm:text-sm tabular-nums">
        ...
        <motion.span
          ...
          className="hidden sm:inline min-w-15 whitespace-nowrap text-right"
        >
          {pingLabel}
        </motion.span>
      </div>
